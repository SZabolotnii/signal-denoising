...
```bash
# Дефолт: deep_space, polygauss_nonstationary, bpsk, 200 000 прикладів
...
└── deep_space_polygauss_nonstationary_bpsk_bs256_n200000_6d07aecc/
    ├── dataset_config.json    <- всі параметри генерації + uid + timestamp
    ├── train/
    │   ├── clean_signals.npy                (200 000 x 256)  float32
    │   ├── gaussian_signals.npy             (200 000 x 256)  float32
    │   ├── non_gaussian_signals.npy         (200 000 x 256)  float32
    │   ├── non_gaussian_noise_only.npy      (200 000 x 256)  float32
    │   └── snr_values.npy                   (200 000,)        float32
    └── test/
        ├── test_m20dB_clean.npy                      (5 000 x 256)
        ├── test_m20dB_gaussian.npy                   (5 000 x 256)
        ├── test_m20dB_non_gaussian.npy               (5 000 x 256)
        ├── test_m20dB_non_gaussian_noise_only.npy    (5 000 x 256)
